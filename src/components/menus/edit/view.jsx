...
import { toggleChecked, addNomalCate, commit } from './action';
...
class EditMenuDetail extends React.Component {
  componentWillMount() {
    const props = this.props;
    props.dispatch(commit('menuDetails', assign({}, props.menuDetails, { position_id: props.params.menuposition })));
...
const propsMaptoState = state => state['menus/edit'];
export default connect(propsMaptoState)(EditMenuDetail);
